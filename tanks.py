...
def Health1(x):
    ...
    pnt = font.render("tank1: " + str(x), True, (0, 0, 0))
    screen.blit(pnt, (20, 20))

def Health2(x):
    font = pygame.font.SysFont("None", 35)
    pnt = font.render("tank2: " + str(x), True, (0, 0, 0))
    screen.blit(pnt, (520, 20))

FPS = 30
clock = pygame.time.Clock()

tank1 = Tank(200, 300, 5, (1, 128, 181))

tank2 = Tank(400, 300, 5, (199, 44, 58), pygame.K_d, pygame.K_a, pygame.K_w, pygame.K_s)

bullets = []

pygame.mixer.init()

sound1 = pygame.mixer.Sound('pip1.wav')
sound2 = pygame.mixer.Sound('pip2.wav')
